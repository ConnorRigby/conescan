...
#endif
{
    ...
    g_Window = SDL_CreateWindow("ConeScan Web Interface", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
...
#if defined(_WIN32) || defined(WIN32) || defined (_WIN64) || defined (WIN64) || defined(_EMSCRIPTEN_)
